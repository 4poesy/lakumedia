...
const LEAGUE_META: Record<string, { name: string; flag: string }> = {
  ...
  uel: { name: 'UEFA Europa League', flag: '🇪🇺' },
  'europa-league': { name: 'UEFA Europa League', flag: '🇪🇺' },
  uecl: { name: 'UEFA Conference League', flag: '🇪🇺' },
  afcon: { name: 'Africa Cup of Nations & Qualifiers', flag: '🌍' },
  'caf-cl': { name: 'CAF Champions League', flag: '🌍' },
  eredivisie: { name: 'Eredivisie (Netherlands)', flag: '🇳🇱' },
  'liga-portugal': { name: 'Liga Portugal Betclic', flag: '🇵🇹' },
  portugal: { name: 'Liga Portugal Betclic', flag: '🇵🇹' },
  mls: { name: 'Major League Soccer (MLS)', flag: '🇺🇸' },
  superlig: { name: 'Trendyol Süper Lig (Turkey)', flag: '🇹🇷' },
  scottish: { name: 'Scottish Premiership', flag: '🏴󠁧󠁢󠁳󠁣󠁴󠁿' },
  brasileirao: { name: 'Brasileirão Betano (Brazil)', flag: '🇧🇷' },
  brazil: { name: 'Brasileirão Betano (Brazil)', flag: '🇧🇷' },
  'liga-argentina': { name: 'Liga Profesional de Fútbol (Argentina)', flag: '🇦🇷' },
  argentina: { name: 'Liga Profesional de Fútbol (Argentina)', flag: '🇦🇷' },
  'liga-mx': { name: 'Liga BBVA MX (Mexico)', flag: '🇲🇽' },
  mexico: { name: 'Liga BBVA MX (Mexico)', flag: '🇲🇽' },
  'world-cup-2026': { name: 'FIFA World Cup 2026 Qualifiers', flag: '🏆' },
  'world-football': { name: 'World Football Championship', flag: '🌍' },
};
