...
import { ArrowLeft, Camera, Award, ChevronRight, UserCheck, ShieldAlert } from 'lucide-react';
...
export default function AboutPage() {
  return (
    <div className="max-w-4xl mx-auto space-y-10 theme-multimedia py-6">
      ...
      <section className="glass-panel p-8 lg:p-12 rounded-3xl border border-slate-800 space-y-6 text-center">
        <div className="relative w-48 sm:w-64 h-24 mx-auto overflow-hidden rounded-2xl bg-white p-3 shadow-xl">
          <Image
            src="/brand/laku-media/laku-media-logo-light.jpeg"
            alt="Laku Media Logo"
            fill
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm font-semibold text-slate-300 flex items-center justify-center gap-1.5">
            <UserCheck className="w-4 h-4 text-[#D9541E]" /> Executive Leadership: <span className="text-white font-bold">Adebayo Samuel Olaku, CEO</span>
          </p>
        </div>
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="glass-panel p-6 rounded-2xl border border-slate-800 space-y-2">
            <h3 className="text-lg font-bold text-white text-[#D9541E]">Music Video Production</h3>
          ...
          <div className="glass-panel p-6 rounded-2xl border border-slate-800 space-y-2">
            <h3 className="text-lg font-bold text-white text-[#D9541E]">Movie Editing</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
          ...
          <div className="glass-panel p-6 rounded-2xl border border-slate-800 space-y-2">
            <h3 className="text-lg font-bold text-white text-[#D9541E]">Television Programme</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
          ...
          <div className="glass-panel p-6 rounded-2xl border border-slate-800 space-y-2">
            <h3 className="text-lg font-bold text-white text-[#D9541E]">Commercial Photography</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
      ...
      <div className="glass-panel rounded-2xl p-8 border border-slate-800 text-center space-y-4">
        <h3 className="text-xl font-bold text-white">Work With Laku Media</h3>
        ...
        <Link
          href="/multimedia/production"
          className="inline-flex items-center px-6 py-3 rounded-xl font-bold bg-[#D9541E] hover:bg-[#b84315] text-white text-xs shadow"
        >
