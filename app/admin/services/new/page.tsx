...
export default function NewServicePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!error) {
      ...
      alert(`Error creating service offering: ${error.message}`);
    }
  };
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 theme-sports pb-12">
      <div className="space-y-2 pb-6 border-b border-slate-800">
        ...
        <h1 className="text-3xl font-extrabold text-white">Create New Production Service</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 glass-panel p-8 rounded-2xl border border-slate-800">
        ...
        <div>
          ...
          <input
            ...
            placeholder="https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=1200"
        ...
        <div className="pt-4 flex items-center justify-end space-x-3">
          ...
          >
            ...
            <span>{loading ? 'Creating...' : 'Save Service Offering'}</span>
          </button>
        </div>
      </form>
    </div>
