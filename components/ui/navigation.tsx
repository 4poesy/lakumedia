    ...
    <header className="sticky top-0 z-50 bg-white border-b border-slate-200 shadow-sm">
      ...
      <div className="bg-[#2A2E7F] text-white border-b border-slate-800 py-3.5 px-4 sm:px-6 lg:px-8 shadow-md">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          {/* Tiny Sleek Radio Button + Auth Action Bar */}
          <div className="hidden md:flex items-center justify-end space-x-2.5">
            <button
              onClick={() => alert('📻 Laku Media Radio is streaming 24/7 live sports commentary!')}
              className="px-3 py-1.5 rounded-xl text-[11px] font-black bg-amber-400 text-slate-950 hover:bg-amber-300 transition-all flex items-center space-x-1 shadow-md border border-amber-300 active:scale-95 cursor-pointer shrink-0"
              title="Laku Media Sports Radio"
            >
              <Radio className="w-3.5 h-3.5 text-slate-900 animate-pulse" />
              <span>LAKU RADIO 📻</span>
            </button>

            <Link
              href="/sign-in"
              prefetch={true}
              className="px-4 py-2 rounded-xl text-xs font-extrabold bg-[#D9541E] hover:bg-[#b84315] text-white transition-all flex items-center space-x-1.5 shadow-md active:scale-95 border border-orange-400 shrink-0"
            >
